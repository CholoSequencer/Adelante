var questions = [
    {
        name: "2016iiQ2ADF1",
        subject: "Literature",
        sub_subject: "Verbal Ability",
        prompt: "(1)Después de identificar y analizar la relación semántica de la serie de cada ítem, seleccione la respuesta más adecuada.",
        image: false,
        question: "(2)Suceder, ocurrir, acontecer,",
        A: "generar",
        B: "acaecer",
        C: "causar",
        D: "iniciar",
    ...
    },
    {
        ...
        prompt: "(1)Después de identificar y analizar la relación semántica de la serie de cada ítem, seleccione la respuesta más adecuada.",
        image: false,
        question: "(2)Atisbar, divisar; descubrir, revelar;",
        A: "segregar, emerger",
    ...
    },
    {
        ...
        subject: "Literature",
        sub_subject: "Verbal Ability",
        prompt: "(1)Lea atentamente cada conjunto oracional y determine el enunciado que debe eliminarse por no corresponder al tema o por ser de índole tangencial.",
        image: false,
        question: "(2)(I) La homeopatía, medicina alternativa creada en 1796 por Samuel Hahnemann, se basa en la doctrina de que lo similar cura lo similar, es decir, una sustancia que cause los síntomas de una enfermedad en personas sanas curará algo parecido en personas enfermas. (II) La homeopatía es considerada una pseudociencia, dado que se ha descubierto que sus remedios no son más efectivos que los placebos, razón por la cual los científicos dudan de su eficacia y la consideran como una pseudoexplicación. (III) Hahnemann creía que las causas subyacentes de las enfermedades eran fenómenos que llamó miasmas y que los remedios homeopáticos actuaban sobre ellas. (IV) Según la doctrina homeopática de Hahnemann, se debe considerar la totalidad de los síntomas de los pacientes, rasgos de personalidad, estado físico e historia de vida. (V) Originalmente, el creador de la homeopatía postuló solo tres miasmas, de las cuales la más importante era la psora (“picazón” en griego), descrita como relacionada a cualquier enfermedad picante de la piel.",
        A: "V",
        B: "I",
        C: "II",
        D: "III",
...
function theQuestion(pregunta, num) {
    "use strict";
    /*jslint es5: true */
    var text = '<div>' + pregunta[num].prompt + '</div>\
        <div class="row prompt">' + pregunta[num].question + '</div>';
    var i = 0;
    for (i = 0; i < questions.length; i++) {
        text += '<p>' + questions[num].A + '</p>';
    }
    return text;
}

document.getElementById("question").innerHTML = theQuestion(questions, 0);